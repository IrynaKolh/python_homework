...
#     print("Sample data inserted successfully.")
    ...
    # cursor.execute("""SELECT Students.name, Courses.course_name FROM Students 
    ...
    # cursor.execute("""SELECT s.name, c.course_name FROM Students AS s 
    ...
    # cursor.execute("""SELECT Students.name, Courses.course_name FROM Enrollments
